...
{$IFNDEF WINNT35COMPATIBLE}
    szServerIpAddress: packed array[0..RAS_MaxIpAddress] of WideChar;
{$ENDIF}
{$IFDEF WINVER_0x500_OR_GREATER}
    dwOptions: DWORD;
...
function RasDial(lpRasDialExtensions: PRasDialExtensions; lpszPhonebook: PWideChar;
...
function RasGetErrorString(uErrorValue: UINT; lpszErrorString: PWideChar;
  cBufSize: DWORD): DWORD; stdcall;
...
function RasCreatePhonebookEntry(hwnd: HWND; lpszPhonebook: PWideChar): DWORD; stdcall;
...
function RasEditPhonebookEntry(hwnd: HWND; lpszPhonebook: PWideChar;
  lpszEntryName: PWideChar): DWORD; stdcall;
...
function RasSetEntryDialParams(lpszPhonebook: PWideChar;
...
function RasGetEntryDialParams(lpszPhonebook: PWideChar;
...
function RasGetEntryProperties(lpszPhonebook: PWideChar; lpszEntry: PWideChar;
...
function RasSetEntryProperties(lpszPhonebook: PWideChar; lpszEntry: PWideChar;
...
function RasRenameEntry(lpszPhonebook: PWideChar; lpszOldEntry: PWideChar;
  lpszNewEntry: PWideChar): DWORD; stdcall;
...
function RasDeleteEntry(lpszPhonebook, lpszEntry: PWideChar): DWORD; stdcall;
...
function RasValidateEntryName(lpszPhonebook, lpszEntry: PWideChar): DWORD; stdcall;
...
function RasGetCredentials(lpszPhonebook, lpszEntry: PWideChar;
...
function RasSetCredentials(lpszPhonebook, lpszEntry: PWideChar;
...
function RasGetSubEntryProperties(lpszPhonebook, lpszEntry: PWideChar;
...
function RasSetSubEntryProperties(lpszPhonebook, lpszEntry: PWideChar;
...
function RasGetAutodialAddress(lpszAddress: PWideChar; lpdwReserved: PDWORD;
...
function RasSetAutodialAddress(lpszAddress: PWideChar; dwReserved: DWORD;
...
function RasDial; external raslib name 'RasDialW';
...
function RasEnumConnections; external raslib name 'RasEnumConnectionsW';
...
function RasEnumEntries; external raslib name 'RasEnumEntriesW';
...
function RasGetConnectStatus; external raslib name 'RasGetConnectStatusW';
...
function RasGetErrorString; external raslib name 'RasGetErrorStringW';
function RasHangUpA; external raslib name 'RasHangUpA';
function RasHangUpW; external raslib name 'RasHangUpW';
function RasHangUp; external raslib name 'RasHangUpW';
...
function RasGetProjectionInfo; external raslib name 'RasGetProjectionInfoW';
...
function RasCreatePhonebookEntry; external raslib name 'RasCreatePhonebookEntryW';
...
function RasEditPhonebookEntry; external raslib name 'RasEditPhonebookEntryW';
...
function RasSetEntryDialParams; external raslib name 'RasSetEntryDialParamsW';
...
function RasGetEntryDialParams; external raslib name 'RasGetEntryDialParamsW';
...
function RasEnumDevices; external raslib name 'RasEnumDevicesW';
...
function RasGetCountryInfo; external raslib name 'RasGetCountryInfoW';
...
function RasGetEntryProperties; external raslib name 'RasGetEntryPropertiesW';
...
function RasSetEntryProperties; external raslib name 'RasSetEntryPropertiesW';
...
function RasRenameEntry; external raslib name 'RasRenameEntryW';
...
function RasDeleteEntry; external raslib name 'RasDeleteEntryW';
...
function RasValidateEntryName; external raslib name 'RasValidateEntryNameW';
...
function RasGetSubEntryHandle; external raslib name 'RasGetSubEntryHandleW';
...
function RasConnectionNotification; external raslib name 'RasConnectionNotificationW';
...
function RasGetSubEntryProperties; external raslib name 'RasGetSubEntryPropertiesW';
...
function RasSetSubEntryProperties; external raslib name 'RasSetSubEntryPropertiesW';
...
function RasGetCredentials; external raslib name 'RasGetCredentialsW';
...
function RasSetCredentials; external raslib name 'RasSetCredentialsW';
...
function RasGetAutodialAddress; external raslib name 'RasGetAutodialAddressW';
...
function RasSetAutodialAddress; external raslib name 'RasSetAutodialAddressW';
...
function RasEnumAutodialAddresses; external raslib name 'RasEnumAutodialAddressesW';
...
function RasGetAutodialEnable; external raslib name 'RasGetAutodialEnableW';
...
function RasSetAutodialEnable; external raslib name 'RasSetAutodialEnableW';
...
function RasGetAutodialParam; external raslib name 'RasGetAutodialParamW';
...
function RasSetAutodialParam; external raslib name 'RasSetAutodialParamW';
{$ENDIF}
...
function RasGetEapUserData; external raslib name 'RasGetEapUserDataW';
...
function RasSetEapUserData; external raslib name 'RasSetEapUserDataW';
...
function RasGetCustomAuthData; external raslib name 'RasGetCustomAuthDataW';
...
function RasSetCustomAuthData; external raslib name 'RasSetCustomAuthDataW';
...
function RasGetEapUserIdentity; external raslib name 'RasGetEapUserIdentityW';
...
function RasFreeEapUserIdentity; external raslib name 'RasFreeEapUserIdentityW';
